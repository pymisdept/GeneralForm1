<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GenMain.aspx.vb" Inherits="Career.GenMain" %>
	    ...
	    <br />
         ...
         <div class="row privacy">
            ...
            <div class="col-sm-6 custmaincol">
			    ...
			    <br />
			    <div style="">本公司的政策是為日後的招聘活動保留 閣下的個人資料十二個月。如本公司的附屬或聯營機構在此期間出現類似的職位空缺，本公司或會將 閣下的申請轉交有關機構考慮。閣下如欲要求查閱及改正職位申請表上所填報的個人資料，請向本公司人力資源部的資料保障主任查詢。</div>
			    <br />
            </div>
         </div>
         
	    <p align="center"><br />        
	        <asp:Button ID="btnAccept" runat="server" Text="Accept 接受" CssClass="" onclick="goRegister" />&nbsp&nbsp&nbsp<asp:Button ID="btnNotAccept" runat="server" Text="Not Accept 不接受" CssClass="" onclientclick="javascript:window.close();" />
	    </p>
        <br />
    </div>
    </form>
