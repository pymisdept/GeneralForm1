<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PGDeclare.aspx.vb" Inherits="Career.PGDeclare" %>
...
<body>
    ...
    <div id="pos_container">
	    ...
	    <p align="center"><br />        
	        <asp:Button ID="btnAccept" runat="server" Text="退出Exit" CssClass="" onclick="goRegister" />&nbsp&nbsp&nbsp</p>
        <br />
    </div>
    </form>
